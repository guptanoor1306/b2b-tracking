...
const STAGE_ICON_MAP: Record<string, LucideIcon> = {
  ...
  '1st Cut Review': MessageSquare,
  '1st Cut Review Done': CheckCircle2,
  '1st Draft Review': MessageSquare,
  '1st Draft Review Done': CheckCircle2,
  '1st Review Changes': Scissors,
  ...
  '2nd Draft Review': MessageSquare,
  '2nd Draft Review Done': CheckCircle2,
  'Request Received': FileText,
  'Ready to Produce': Sparkles,
